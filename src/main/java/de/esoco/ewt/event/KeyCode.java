...
public enum KeyCode {
	...
	META(91), CONTEXT_MENU(93), ENTER(13), ESCAPE(27), BACKSPACE(8),
	DELETE(46),
	INSERT(45), TAB(9), HOME(36), END(35), PAGE_UP(33), PAGE_DOWN(34),
	DOWN(40),
	...
	PERCENT('%'), AMPERSAND('&'), LEFT_PARENTHESIS('('),
	RIGHT_PARENTHESIS(')'),
	...
	/**
	 * Allows to retrieve the KeyCode instance that is associated with a
	 * certain
	 ...
	 * "$KeyPageUp", for SPACE it will be "$KeySpace". The resource string
	 * for A
	 * will simply be "A".
	 *
