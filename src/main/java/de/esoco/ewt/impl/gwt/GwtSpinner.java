	...
	implements Focusable, HasEnabled, HasValueChangeHandlers<Integer>
{
	...
	private PushButton aIncrementButton =
		createSpinButton(RES.imArrowUp(),
						 RES.imArrowUpPressed(),
						 RES.imArrowUpHover(),
						 RES.imArrowUpDisabled());
	private PushButton aDecrementButton =
		createSpinButton(RES.imArrowDown(),
						 RES.imArrowDownPressed(),
						 RES.imArrowDownHover(),
						 RES.imArrowDownDisabled());
			   ...
			   ValueBox<Integer> rInputField)
	{
		...
		aInputField.addKeyPressHandler(new IntRangeConstraint(nMinimum,
															  nMaximum));
	...
	private void checkValue(Integer rValue, int nIncrement, boolean bWrap)
	{
		...
		{
			nValue =
				bWrap ? nMaximumValue / nIncrement * nIncrement : nMinimumValue;
		}
	...
	private PushButton createSpinButton(ImageResource rImUp,
										ImageResource rImPressed,
										ImageResource rImHover,
